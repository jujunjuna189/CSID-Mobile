...
import 'package:csid_mobile/pages/learning_preview/widget/popup_lesson.dart';
          ...
          child: Stack(
            children: [
                                          ...
                                          item.value.source?.source == "external_url"
                                              ...
                                              : blocLearningPreview.loadVideo(
                                                  blocLearningPreview.videoSources =
                                                      item.value.source?.sourceYoutube ?? '',
                                                  isLoading: true,
                                                );
                                        },
                                        child: Container(
              ...
              ValueListenableBuilder(
                valueListenable: blocLearningPreview.videoController!,
                builder: (context, value, child) {
                  return value.isFullScreen ? const PopupLesson() : Container();
                },
              )
            ],
          ),
